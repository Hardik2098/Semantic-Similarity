...
def create_train_dev_set(tokenizer, sentences_pair, is_similar, max_sequence_length, validation_split_ratio):
    ...
    train_padded_data_1 = pad_sequences(train_sequences_1, maxlen=max_sequence_length, padding = 'post')
    train_padded_data_2 = pad_sequences(train_sequences_2, maxlen=max_sequence_length, padding = 'post')
